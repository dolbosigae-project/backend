...
public class PlPageVo {
	//전체 게시글 개수
		...
		public PlPageVo(int count, int currentPage, int pageOfContentCount) {
			this.count = count;
		...
		public String toString() {
			return "PageVo [count=" + count + ", currentPage=" + currentPage + ", pageOfContentCount="
