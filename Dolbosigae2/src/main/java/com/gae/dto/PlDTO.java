...
public class PlDTO {
	...
	public PlDTO(String plId, String plName, String plHour, String plTel, String plAddress, String plInfo,
			String plExpense, String plImg, String plArea, String plDay) {
		super();
		this.plId = plId;
		this.plName = plName;
		this.plHour = plHour;
