...
public class ABPaggingVo {
	...
	public ABPaggingVo(int count, int currentPage, int pageOfContentCount) {
		this.count = count;
	...
	public String toString() {
		return "ABPaggingVo [count=" + count + ", currentPage=" + currentPage + ", pageOfContentCount="
