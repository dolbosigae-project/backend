...
public class ShelterPaggingVo {
	...
	public ShelterPaggingVo(int count, int currentPage, int pageOfContentCount) {
		this.count = count;
	...
	public String toString() {
		return "ShelterPaggingVo [count=" + count + ", currentPage=" + currentPage + ", pageOfContentCount="
